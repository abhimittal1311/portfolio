        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-[#1a1a1a] p-8 rounded-[16px] w-[400px]">
            ...
            <div className="flex justify-center">
              <button
                className="bg-[#333333] text-white py-2 px-6 rounded-[10px] hover:bg-[#444444]"
                onClick={closeModal}
              >
                Close
              </button>
    ...
    <div className="-mt-[6rem]">
      ...
      <div className="w-full flex">
        ...
        >
          ...
          a link to the magic behind the scenes (aka the code repo), with a live demo on the
          way. Think of it as a techie treasure chest showcasing my journey through coding
          adventures!
        </motion.p>
      </div>
